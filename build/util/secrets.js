...
if (fs_1.default.existsSync(".env")) {
    ...
    logger_1.default.debug("Using .env.production file to supply config environment variables");
    dotenv_1.default.config({ path: ".env.production" }); // you can delete this after you create your own .env file!
}
